...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2">
      <div className="relative flex items-center gap-0.5 rounded-full border border-white/10 bg-white/10 px-1.5 py-1.5 shadow-[0_8px_32px_0_rgba(0,0,0,0.04)] backdrop-blur-3xl dark:border-white/5 dark:bg-gray-950/10 dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
